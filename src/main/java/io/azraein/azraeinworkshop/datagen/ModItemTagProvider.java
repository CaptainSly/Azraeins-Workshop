...
public class ModItemTagProvider extends ItemTagsProvider {
        ...
        protected void addTags(Provider provider) {
                ...
                tag(ItemTags.TRIMMABLE_ARMOR).add(ModItems.FIRE_METAL_HELMET.get(),
                ModItems.FIRE_METAL_CHESTPLATE.get(),
                ...
                tag(ModTags.Items.TANNING_KNIFE).add(ModItems.WOOD_KNIFE.get(), ModItems.COBBLE_KNIFE.get(),
                                ModItems.IRON_KNIFE.get(), ModItems.FIRE_METAL_KNIFE.get(),
